...
#        clusterNum = cvForDiffClusters.index(max(cvForDiffClusters)) + 1 
        ...
        clf = [svm.SVC(C=5, kernel='rbf') for i in range(self.clusterNum)]
...
#        macroData = preprocessing.scale(macroData)
...
if __name__ == "__main__":
    ...
    'harley-davidson', 'toyota', 'boeing', 'jpmorgan', 'boa', 'amgen', 'hermanMiller',
    'nissan', 'generalElectric', 'nextEra', 'conocoPhillips', 'bakerHughes', 'dukeEnergy', 'chevron']
#    companies = ['microsoft', 'boeing', 'toyota', 'walmart']
#   companies = ['toyota']
